...
namespace visionary
{
	...
	public:
		...
		/// <param name="presentation">Definition how invalid points should be presented inside the PLY file [optional]</param>
		...
		/// <summary>Save a point cloud to a file in Polygon File Format (PLY) which has intensities and colors for each point, see: https://en.wikipedia.org/wiki/PLY_%28file_format%29 </summary>
		/// <param name="filename">The file to save the point cloud to</param>
		/// <param name="points">The points to save</param>
		/// <param name="rgbaMap">RGBA colors for each point, must be same length as points</param>
		/// <param name="intensityMap">Intensities for each point, must be same length as points</param>
