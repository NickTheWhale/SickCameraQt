...
namespace visionary
{
	...
	{
	public:
		FrameGrabber(const std::string& hostname, std::uint16_t port, std::uint64_t timeoutMs)
		...
		bool getNextFrame(std::shared_ptr<DataType>& pDataHandler, std::uint64_t timeoutMs = 1000)
		{
