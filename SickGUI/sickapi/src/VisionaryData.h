...
namespace visionary
{
	...
	private:
		...
		// Bits of the devices timestamp: 5 unused - 12 Year - 4 Month - 5 Day - 11 Timezone - 5 Hour - 6 Minute - 6 Seconds - 10 Milliseconds
		// .....YYYYYYYYYYYYMMMMDDDDDTTTTTTTTTTTHHHHHMMMMMMSSSSSSmmmmmmmmmm
		static constexpr uint64_t BITMASK_YEAR = 0x7FF800000000000; // 0000011111111111100000000000000000000000000000000000000000000000
		static constexpr uint64_t BITMASK_MONTH = 0x780000000000;   // 0000000000000000011110000000000000000000000000000000000000000000
		static constexpr uint64_t BITMASK_DAY = 0x7C000000000;      // 0000000000000000000001111100000000000000000000000000000000000000
		static constexpr uint64_t BITMASK_HOUR = 0x7C00000;         // 0000000000000000000000000000000000000111110000000000000000000000
		static constexpr uint64_t BITMASK_MINUTE = 0x3F0000;        // 0000000000000000000000000000000000000000001111110000000000000000
		static constexpr uint64_t BITMASK_SECOND = 0xFC00;          // 0000000000000000000000000000000000000000000000001111110000000000
		static constexpr uint64_t BITMASK_MILLISECOND = 0x3FF;      // 0000000000000000000000000000000000000000000000000000001111111111
	};
