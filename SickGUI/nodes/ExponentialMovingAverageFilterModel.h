...
class ExponentialMovingAverageFilterModel : public QtNodes::NodeDelegateModel
{
	Q_OBJECT

public:
	ExponentialMovingAverageFilterModel();
	~ExponentialMovingAverageFilterModel() = default;

public:
	QString caption() const override { return QString("Exponential Moving Average Filter"); }

	QString name() const override { return QString("Exponential Moving Average Filter"); }

public:
	virtual QString modelName() const { return QString("Exponential Moving Average Filter"); }
...
private:
	...
	QDoubleSpinBox* sb_alpha = nullptr;
