...
#include <nodeeditor/src/UndoCommands.hpp>
...
namespace QtNodes {
	...
	FilterFlowGraphicsScene::FilterFlowGraphicsScene(FilterFlowGraphModel& graphModel, QObject* parent)
		: BasicGraphicsScene(graphModel, parent)
		, _graphModel(graphModel)
	{
		connect(&_graphModel,
			&FilterFlowGraphModel::inPortDataWasSet,
			[this](NodeId const nodeId, PortType const, PortIndex const) { onNodeUpdated(nodeId); });
	}

	// TODO constructor for an empyt scene?

	std::vector<NodeId> FilterFlowGraphicsScene::selectedNodes() const
	{
	...
	QMenu* FilterFlowGraphicsScene::createSceneMenu(QPointF const scenePos)
	{
	...
	void FilterFlowGraphicsScene::load()
	{
