...
try:
    ...
    while True:
        if args.transport_protocol == "TCP":
            ...
            # if oldFrameNumber + 1 != myData.depthmap.frameNumber:
            #     print(f"\033[91m Frames where skipped {myData.depthmap.frameNumber - (oldFrameNumber +1)} \033[0m")
            # oldFrameNumber = myData.depthmap.frameNumber
